  ...
  return (
    <div className="flex-1 flex gap-8 items-start">
      ...
      <main className="flex-1 space-y-6">
        <div>
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-600 text-[11px] font-bold mb-2">
        ...
        <div className="p-4 rounded-2xl bg-blue-50/60 border border-blue-100 flex items-start gap-3 text-xs text-blue-900">
          ...
          <div>
            ...
            <p className="text-slate-600 text-[11px] mt-0.5">Completar tu perfil no afecta a la aprobación de tu cuenta.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-6">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <span>{isSubmitting ? 'Registrando...' : 'Continuar y finalizar inscripción'}</span>
                <ArrowRight size={16} />
              </button>
            </div>
          </div>
