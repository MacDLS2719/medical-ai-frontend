      ...
      <aside className="w-80 shrink-0 flex flex-col gap-6">
        ...
        <div className="p-4 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center gap-3">
          ...
          <div className="text-xs">
            ...
            <p className="text-slate-500">Escríbenos a <span className="text-blue-600 font-medium">soporte@vitalia.com</span></p>
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-5">
            <div>
              <h2 className="text-base font-extrabold text-slate-900">Información profesional</h2>
              <p className="text-xs text-slate-500 mt-0.5">Cuéntanos más sobre tu práctica médica.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Especialidad principal</label>
                <input
                  type="text"
                  name="specialty"
                  required
